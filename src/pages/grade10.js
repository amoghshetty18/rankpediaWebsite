...
import MusicArea from "../sections/grade10/MusicArea";
import MusicArea2 from "../sections/grade10/MusicArea2";
...
<div className="min-height-100vh d-flex align-items-center bg-dark-cloud1 pt-24 pt-md-27 pt-lg-25">
        ...
        <div className="container pt-15" id="for-tabs-grade-chnges-10">
