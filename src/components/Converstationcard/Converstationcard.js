...
const Conversationcard = ({ img, title, Discription, className, ...rest }) => {
  return (
    <div className={className} {...rest}>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 pt-14 pd-lft-0" data-aos="flip-right" data-aos-duration="1000" data-aos-once="true">
            <div class="content-img sxrty-prprs">
           <img class="ptyuc-rtyd" src={img} alt="" />
          ...
          <div class="col-10 col-lg-6 imgs-imt">
            <div class="section-title content-text mb-13" data-aos="fade-left" data-aos-duration="500" data-aos-once="true">
              ...
              <p class="gr-text-8 clscls">{Discription}</p>
