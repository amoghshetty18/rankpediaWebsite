  ...
  return (
    <>
      ...
      <SiteHeader
        ...
        }  dynamic-sticky-bg site-header--absolute site-header--sticky
      ...
      <div id="popup1" class="overlay">
        <div class="popup">
          ...
          <div class="">
            <p class="popup-para">
              Enter your details below to lorem ipsum Sed ut perspiciatis unde
            </p>

            <form action="" id="rmdts">
              <label class="firstname" for="fname">
                Student name
              </label>
              <br />
              <input
