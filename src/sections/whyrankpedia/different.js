...
const Different = (props) => {
  ...
  return (
    <div className="row mt-18 mb-sm-10 mb-md-20" id="no-desgn-wstr">

<div className="col-sm-6 ">
      <div
              className="mt-sm-0 mt-lg-15 rdsr-cvxq-snc"
              data-aos="fade-right"
              data-aos-delay={500}
              data-aos-once="true"
            >
      ...
      <div className="col-sm-6">
      <div
              className="Desktop-view l4-content-img-2 ml-lg-10 ml-xl-7 rounded-10 text-center"
              data-aos="fade-right"
