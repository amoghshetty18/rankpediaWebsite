        ...
        <div className="row ">
          <div className="col-md-7">
            ...
            >
              ...
              <p className="font-size-7 mb-0">Download the NCERT books</p>
            </div>
          </div>
        </div>
        {/* End Section Title */}
        <div className="pt-13 pt-lg-16">
          <div className="row justify-content-center px-xl-0">
            ...
            <div className="col-xl-3 col-lg-4 col-md-5 col-sm-7 col-xs-8">
              <a href="https://rankpedia-images.s3.ap-south-1.amazonaws.com/10-English.zip">
                <div
                ...
                >
                  <div className="mb-10">
                    <img
                      className="intr-intr-omgs"
                      src={
                        "https://res.cloudinary.com/ddo1ag5nz/image/upload/v1627649163/mentors-landing/books-removebg-preview_1_yieaha.png"
                      }
                      alt=""
                    />
            ...
            {/* single card */}
            <div className="col-xl-3 col-lg-4 col-md-5 col-sm-7 col-xs-8">
            <a href="https://rankpedia-images.s3.ap-south-1.amazonaws.com/10-Maths.zip"> 
              <div
                className="card-same rounded-15 text-center px-10 py-10 gr-hover-3 mb-9 border border-default-color"
                data-aos="zoom-in"
              ...
              >
                <div className="mb-10">
                  ...
                  />
                  <img
                    className="wdts-mgdtr"
                    src={
                      "https://res.cloudinary.com/ddo1ag5nz/image/upload/v1623685507/maths-icon_eszouk.svg"
                    }
                    alt=""
                  />
                </div>
            ...
            {/* single card */}
            <div className="col-xl-3 col-lg-4 col-md-5 col-sm-7 col-xs-8">
            <a href="https://rankpedia-images.s3.ap-south-1.amazonaws.com/10-science.zip">
              <div
                className="card-same rounded-15 text-center px-10 py-10 gr-hover-3 mb-9 border border-default-color"
                data-aos="zoom-in"
              ...
              >
                <div className="mb-10">
                  ...
                  <img
                    className="wdts-mgdtr"
                    src={
                      "https://res.cloudinary.com/ddo1ag5nz/image/upload/v1622811954/Mask_Group_22_fj8tta.png"
                    }
                    alt=""
                  />
                </div>
            ...
            {/* single card */}
            <div className="col-xl-3 col-lg-4 col-md-5 col-sm-7 col-xs-8">
            <a href="https://rankpedia-images.s3.ap-south-1.amazonaws.com/10-Social-Science.zip">
              <div
                className="card-same rounded-15 text-center px-10 py-10 gr-hover-3 mb-9 border border-default-color"
                data-aos="zoom-in"
          ...
          <div className="row  px-xl-0">
            {/* single card */}
            <div className="col-xl-3 col-lg-4 col-md-5 col-sm-7 col-xs-8">
            <a href="https://rankpedia-images.s3.ap-south-1.amazonaws.com/10-Hindi.zip">
              <div
                className="card-same rounded-15 text-center px-10 py-10 gr-hover-3 mb-9 border border-default-color"
                data-aos="zoom-in"
                data-aos-duration={300}
