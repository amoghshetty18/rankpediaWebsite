...
function Section1({ className, title, description, ...rest }) {
  return (
    ...
    <div className={className} {...rest}>
      <div class="hero-area" id="roller-bnr" style={{backgroundImage: `url(${"https://res.cloudinary.com/ddo1ag5nz/image/upload/v1643352216/continuing-education/hero/Slide_3_k3j96i.png"})`}}>
        <div className="container-fluid px-10">
          <div className="row">
            <div className="col-lg-6">
              <div class="hero-content dark-mode-texts">
                <h4 class="gr-text-5 mb-9 learnon">Continuing Education by Rankpedia| Join any course of your choice</h4>
