...
const MusicArea = ({ className, ...rest }) => {
  ...
  //  const src="https://drive.google.com/file/d/17URn5YRbnfpcPq3N2gJzxGb4e0992Xd9/view?usp=sharing"
    ...
    const downloadUrl = window.URL.createObjectURL(new Blob([data.data]));
        ...
        link.setAttribute('download', '9-maths1-v1.zip'); //any other extension
  ...
  //  const src="https://drive.google.com/file/d/17URn5YRbnfpcPq3N2gJzxGb4e0992Xd9/view?usp=sharing"
    ...
    const downloadUrl = window.URL.createObjectURL(new Blob([data.data]));
        const link = document.createElement('a');
        link.href = downloadUrl;
        link.setAttribute('download', '9-science-v1.zip'); //any other extension
        document.body.appendChild(link);
        link.click();
        link.remove();
  }
      ...
      <div className="container">
        ...
        <div className="pt-13 pt-lg-16">
          <div className="row  px-xl-0">
            ...
            <a href="https://rankpedia-images.s3.ap-south-1.amazonaws.com/NCERT+SYLLABUS+FOR+MATHS+(Grade+9).pdf" target="_blank">
              <div
            ...
            {/* single card */}
            <div className="col-xl-3 col-lg-4 col-md-5 col-sm-7 col-xs-8">
            <a href="https://rankpedia-images.s3.ap-south-1.amazonaws.com/NCERT+SYLLABUS+FOR+SCIENCE+(GRADE+9).pdf" target="_blank">
              <div
                className="card-same rounded-15 text-center px-10 py-10 gr-hover-3 mb-9 border border-default-color"
                data-aos="zoom-in"
